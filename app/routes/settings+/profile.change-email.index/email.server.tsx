        ...
        <Tailwind config={tailwindConfig}>
            <Html lang="en" dir="ltr">
                <Container>
                    ...
                    <p>
                        <Text>
                            We're writing to let you know that your Epic Notes
                            email has been changed.
                        </Text>
                    </p>
                    <p>
                        <Text>
                            If you changed your email address, then you can
                            safely ignore this. But if you did not change your
                            email address, then please contact support
                            immediately.
                        </Text>
                    </p>
                    <p>
